...
def dulich(request):
    with connection.cursor() as cursor:
        ...
        and bcv.khachhang_dimension = 'DuLich') x group by x.vanphongdaidien_dimension""")
        res = dictfetchall(cursor)
...
def dulich_filter1(request, sanpham_id):
    with connection.cursor() as cursor:
        ...
        and bcv.mathang_dimension = %s) x group by x.vanphongdaidien_dimension""", [sanpham_id])
        res = dictfetchall(cursor)
...
def buudien_filter1(request, sanpham_id):
    with connection.cursor() as cursor:
        ...
        group by x.vanphongdaidien_dimension""", [sanpham_id])
        res = dictfetchall(cursor)
