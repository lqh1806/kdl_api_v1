...
urlpatterns = [
    ...
    path('all/bang/<str:city_name>/', filter6, name='filter6'),
    path('all/bang/<str:city_name>/<int:sanpham_id>/', filter7, name='filter7'),
    path('all/bang/<str:city_name>/<int:sanpham_id>/nam/<int:year_id>/', filter8, name='filter8'),
    path('all/bang/<str:city_name>/<int:sanpham_id>/quy/<int:quarter_id>/', filter9, name='filter9'),
    path('all/bang/<str:city_name>/nam/<int:year_id>/', filter10, name='filter10'),
    path('all/bang/<str:city_name>/quy/<int:quarter_id>/', filter11, name='filter11'),
